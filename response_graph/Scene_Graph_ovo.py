...
def Scene_Graph_generation_wo_query(processor, model, current_frame_tokens, question=None):
    """
...
def Scene_Graph_generation_Real(processor, model, current_frame_tokens, question=None, Query_Graph=None):
    """
    Generate Scene Graph for the current video frame
    """
...
def Scene_Graph_generation_CRR(processor, model, current_frame_tokens, question=None, Query_Graph=None):
    """
    Generate Scene Graph for the current video frame
    """
    if Query_Graph is not None:
    ...
    prompt = """
        ...
        **Scene Graph**
        ...
        ...
    """
    formatted_prompt = prompt.format(question=question, terminology_text=terminology_text)
